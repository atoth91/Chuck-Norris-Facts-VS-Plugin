...
namespace ChuckNorrisFacts
{
    ...
    internal sealed class MainToolWindowCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("823113e2-964c-48c0-864b-fe33b28a20cd");
        ...
        {
            // Verify the current thread is the UI thread - the call to AddCommand in MainToolWindowCommand's constructor requires
            // the UI thread.
